...
Devise.setup do |config|
  ...
  # config.secret_key = '091ca6573cae5a2a36dc334452ec38e8bebef7b02ff27bf1a9118c965e97383560db6e8b0c07030b4639dc6cf001aa2d9f3bca1f8d31bfb7e7ffe60d1a125155'
  ...
  config.omniauth :openid_connect, {:scope => [:openid, :email, :profile, :address], :response_type => :code, :discovery => true, :client_options => {:redirect_uri => ENV["OIDC_URL"], :identifier => ENV["OIDC_KEY"], :secret => ENV["OIDC_SECRET"], :host => ENV["OIDC_HOST"], :scheme => ENV["OIDC_SCHEME"], :port => ENV["OIDC_PORT"]}}
  ...
  # config.pepper = '26ba8c956e00279c5b48e88a1d58e2d54b79cf14d8b58d91709b4ff2d1249a4809f8c52de0025bb992c0d8db63fe31714d1d094ee9b271cab1918109286fd8b6'
